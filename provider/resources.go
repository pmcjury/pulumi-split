...
const (
	...
	mainPkg = "split"
	// modules:
	mainMod = "index" // the split module
)
...
func Provider() tfbridge.ProviderInfo {
	...
	p := shimv2.NewProvider(split.Provider())
	...
	prov := tfbridge.ProviderInfo{
		...
		PluginDownloadURL: "",
		Description:       "A Pulumi package for creating and managing split cloud resources.",
		// category/cloud tag helps with categorizing the package in the Pulumi Registry.
		// For all available categories, see `Keywords` in
		// https://www.pulumi.com/docs/guides/pulumi-packages/schema/#package.
		Keywords:   []string{"pulumi", "split", "category/cloud"},
		License:    "Apache-2.0",
		Homepage:   "https://www.pulumi.com",
		Repository: "https://github.com/pulumi/pulumi-split",
	...
	prov.MustComputeTokens(tokens.SingleModule("split_", mainMod,
